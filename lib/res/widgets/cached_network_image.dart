        ...
        child: !isValEmpty(imageUrl)
            ? CachedNetworkImage(
                ...
                progressIndicatorBuilder: (showProgressIndicator ?? false
                    ...
                    : null),
                placeholder: (showProgressIndicator ?? true ? (context, url) => ShimmerUtils.shimmer(child: ShimmerUtils.shimmerContainer(width: width, height: height ?? Get.height * 0.225, borderRadius: 10)) : null),
