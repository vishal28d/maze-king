...
class _ConditionalWillPopScopeState extends State<ConditionalWillPopScope> {
  ...
  void didChangeDependencies() {
    ...
    if (widget.onWillPop != null) {
      ...
      if (widget.shouldAddCallback) _route?.addScopedWillPopCallback(widget.onWillPop!);
    }
  }
  ...
  void didUpdateWidget(ConditionalWillPopScope oldWidget) {
    ...
    if (widget.onWillPop != oldWidget.onWillPop || widget.shouldAddCallback != oldWidget.shouldAddCallback) {
      ...
      if (widget.onWillPop != null && widget.shouldAddCallback) _route?.addScopedWillPopCallback(widget.onWillPop!);
    }
  }
